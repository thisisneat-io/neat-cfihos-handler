...
from cfihos_handler._processor import CFIHOSProcessor


class TestCFIHOSProcessor:
    """Test suite for CFIHOSProcessor."""

    @patch("cfihos_handler._processor.NeatReader")
    @patch("cfihos_handler._reader.CFIHOSReader")
    ...
    @patch("cfihos_handler._processor.CFIHOSReader")
    @patch("cfihos_handler._processor.NeatReader")
